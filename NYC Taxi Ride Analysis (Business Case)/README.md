...
## 📌 Project Background  
As a new data analyst at **Automatidata**, a data consulting firm, my role is to help the **NYC TLC** develop a **regression model** to estimate taxi fares before rides.  
TLC manages over **200,000 licensed vehicles**, making approximately **one million trips daily**.  
By developing this model, TLC can:  
